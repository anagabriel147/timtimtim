...
Parte do monorepo TimTim — ver [README na raiz](../../README.md).

> Protótipo de interface: todos os dados são mocks locais, sem backend.

## Começar

Instalar e rodar a partir da raiz do monorepo (`pnpm install` é único para todos
os pacotes):
