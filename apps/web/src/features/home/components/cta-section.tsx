...
export function CtaSection({
  ...
  return (
    <section id="categorias" className="px-6 py-16 md:py-20">
      <div className="border-primary/30 from-primary/10 to-card/40 mx-auto max-w-5xl overflow-hidden rounded-3xl border bg-gradient-to-b px-6 py-14 text-center md:py-16">
        ...
        <h2 className="font-display text-foreground mx-auto mt-5 max-w-2xl text-3xl leading-tight font-bold tracking-tight text-balance md:text-4xl">
