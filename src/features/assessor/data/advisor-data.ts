import type { AdvisorNavItem, AdvisorWedding, Commission, Referral, ReferralStatus, TopVendor, WeddingPhase } from '../types'
...
export const ADVISOR_STATS = [
  { id: 'active', label: 'Casamentos Ativos', value: '6', tag: 'ATIVOS', delta: '+1 este mês', icon: 'help' },
  { id: 'refs', label: 'Indicações Geradas', value: '34', tag: 'TOTAL', delta: '+8 esta semana', icon: 'link' },
  { id: 'comms', label: 'Comissões Recebidas', value: 'R$8,4k', tag: 'MÊS', delta: '+R$2,1k vs anterior', icon: 'rs' },
  { id: 'score', label: 'Avaliação Média', value: '4.9', tag: 'SCORE', delta: 'Top 3% assessoras', icon: 'star' },
] as const
...
export const RECENT_COMMISSIONS: Commission[] = [
  { id: 'c-1', label: 'Fotografia — Aline & JP', vendor: 'Fornecedor: LuzArte Studio', amount: '+R$480', date: 'Jun 10', icon: 'camera' },
  { id: 'c-2', label: 'Banda — Beatriz & Lucas', vendor: 'Fornecedor: Orquestra Éclat', amount: '+R$1.200', date: 'Jun 08', icon: 'music' },
  { id: 'c-3', label: 'Floricultura — Camila & F', vendor: 'Fornecedor: Botânica Viva', amount: '+R$640', date: 'Jun 05', icon: 'flower' },
  { id: 'c-4', label: 'Buffet — Marina & Rafael', vendor: 'Fornecedor: Bella Tavola', amount: '+R$2.100', date: 'Jun 02', icon: 'utensils' },
  { id: 'c-5', label: 'Videografia — Aline & JP', vendor: 'Fornecedor: CineFrame Pro', amount: '+R$760', date: 'Mai 28', icon: 'video' },
]
...
> = {
  ...
  pendente: { label: 'PENDENTE', className: 'border-yellow-500/40 bg-yellow-500/10 text-yellow-500' },
  analise: { label: 'EM ANÁLISE', className: 'border-purple-400/40 bg-purple-400/10 text-purple-300' },
}
...
export const TOP_VENDORS: TopVendor[] = [
  ...
  { id: 'tv-4', name: 'CineFrame Pro', amount: 'R$760*', icon: 'video', percent: 36, note: 'pendente' },
...
export type { AdvisorNavItem, AdvisorWedding, Commission, Referral, ReferralStatus, TopVendor, WeddingPhase }
