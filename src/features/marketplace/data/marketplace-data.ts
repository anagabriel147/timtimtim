...
export const VENDOR_PROFILE = {
  ...
  portfolio: {
    total: '48 trabalhos',
    images: [
      '/images/fornecedores/portfolio-1.png',
      '/images/fornecedores/portfolio-2.png',
    ],
    extraCount: '+45 fotos',
  ...
  about: {
    ...
    services: [
      { title: 'Decoração Completa de Salão', desc: 'Mesa de convidados, altar, bar e zonas de fotos' },
      { title: 'Instalações Florais Suspensas', desc: 'Arranjos aéreos, dossel de flores e greenwall' },
      { title: 'Iluminação Cênica & Ambiental', desc: 'LED, velas, spots e luz monocromática personalizada' },
      { title: 'Consultoria & Projeto 3D', desc: 'Renderização do ambiente antes do evento' },
      { title: 'Locação de Mobiliário Premium', desc: 'Cadeiras tiffany, sofás chesterfield e aparadores' },
    ],
  },
  verified: {
  ...
  quote: {
    ...
    infoTail: 'já foi selecionado automaticamente. Detalhe abaixo o que você precisa para este fornecedor.',
    lockedEvent: {
    ...
    venueOptions: ['Salão de festas', 'Espaço ao ar livre', 'Quinta / Fazenda', 'Hotel', 'Ainda a definir'],
    services: [
