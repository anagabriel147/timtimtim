...
export function RoleSelection() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <h1 className="mt-6 text-center font-display text-4xl font-semibold tracking-tight text-foreground text-balance md:text-5xl">
        ...
        {ROLES.map((role) => {
          ...
          return (
            <label
              key={role.id}
              className={cn(
                'group relative flex cursor-pointer flex-col rounded-2xl border bg-card/60 p-6 transition-all',
                isActive
            ...
            >
              ...
              <span
                aria-hidden="true"
                className={cn(
                  'absolute right-6 top-6 grid size-5 place-items-center rounded-full border transition-colors',
                  isActive
              ...
              <span className="mt-6 text-xs font-semibold tracking-widest text-primary">
                {role.eyebrow}
              </span>
              <span className="mt-1 font-display text-xl font-semibold text-foreground text-balance">
                {role.title}
              </span>
              ...
              <ul className="mt-5 space-y-3">
                {role.features.map((feature) => (
                  ...
                  >
                    <span
                      className="mt-0.5 grid size-4 shrink-0 place-items-center rounded-full bg-primary/20 text-primary"
                      aria-hidden="true"
                    >
